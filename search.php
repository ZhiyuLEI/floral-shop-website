...
<body onload="if (document.getElementById('zoom_searchbox')) {document.getElementById('zoom_searchbox').focus();}">
	...
	<form method="get" action="/iwd14s2/leiz03iwd/Project2/search.php" class="zoom_searchform"></form><!--Zoom Search Engine Version 7.0 (1004)-->
<center><p><small>Search powered by <a href="http://www.wrensoft.com/zoom/" target="_blank"><b>Zoom Search Engine</b></a></small></p></center></body>
</html>
